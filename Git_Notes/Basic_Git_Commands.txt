...
Checkout:	
	...
	•	git checkout -b branchname origin/branchname
		...
		be any local branch that will keeps track of the changes happining to the remote , so when we check out of the main branch 
		we will create a new local branch that tracks the remote branch)
------------------------------------------------------------------------------------------------------------------------------------------
Switch:	
	Command:
